...
class Patient():
    def __init__(self, root):
        ...
        # =====Bg Image===
        self.bg = ImageTk.PhotoImage(file="F:/xj/bg4.jpg")
        bg = Label(self.root, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)

        # =====Left Image===
        self.left = ImageTk.PhotoImage(file="F:/xj/co1.jpg")
        ...
        docinfotn = Button(title_frame, text="Doctor info", width=10, pady=5, bd=0,command=self.doctor_window,
                           font=("times new roman", 16, "bold")).place(x=150,
                                                                       y=13,
                                                                       width=130)

        relpaytn = Button(title_frame, text="rel & pay", width=10, pady=5, bd=0, command=self.relpay,
        ...
        self.txt_address = Text(frame1, width=20, height=2, font=("times new roman", 13, "bold"), bg="lightgray")
        ...
        updatebtn = Button(self.root, text="UPDATE", width=10, pady=5, bd=1, fg="darkorange", bg="white",command=self.update_data).place(x=170, y=670, width=80)
        deletebtn = Button(self.root, text="DELETE", width=10, pady=5, bd=1, fg="darkorange", bg="white",command=self.delete_data).place(x=270, y=670, width=80)
        ...
        searchbtn = Button(details_Frame, text="Search", width=8, pady=5,command=self.search_data).grid(row=0, column=4, padx=5, pady=5)
    ...
    def add_patients(self):
        if self.Test_ID.get()=="" or self.Name_var=="":
            ...
            cur = con.cursor()
            cur.execute("INSERT INTO C_PATIENT VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (self.Patient_var.get(),
                                                                                         self.Name_var.get(),
                                                                                         self.Test_ID.get(),
                                                                                              self.Phone_var.get(),
                                                                                         self.Gender_var.get(),
    ...
    def update_data(self):
        con = pymysql.connect(host="localhost", user="root", database="c_patient")
        cur = con.cursor()
        cur.execute("update c_patient set name=%s, test_id=%s,phone=%s,gender=%s,doctor=%s,room_no=%s,relatives_no=%s,age=%s,"
                    "address=%s,admission=%s,discharge=%s where patient_id=%s", (
                                                                                          self.Name_var.get(),
                                                                                          self.Test_ID.get(),
                                                                                          self.Phone_var.get(),
                                                                                          self.Gender_var.get(),
...
#=====2 window=====
    def doctor_window(self):
        ...
        ho1 = Button(h1, text="QCMS", width=100, pady=10, bd=0,bg="white" ,font=("times new roman", 30, "bold"),fg="darkorange").place(x=70, y=0, width=200)
    ...
    def relpay(self):
        ...
        title = Label(title_frane, text="RELATIVE'S & PAYMENT DETAILS ", bg="khaki", fg="black", font=("times new roman", 25, "bold"))
        title.place(x=350, y=17)

        rel = Frame(self.rele, bg="lightblue", bd=10)
        ...
        patient_id = Label(rel, text="Patient ID :", bg="lightblue", fg="black",
                           font=("times new roman", 17, "bold"))
        patient_id.grid(row=2, column=0, pady=10, padx=20, sticky="w")
        ...
        r_name = Label(rel, text="Relative Name :", bg="lightblue", fg="black",
                           font=("times new roman", 17, "bold"))
        ...
        r_ph = Label(rel, text="Phone :", bg="lightblue", fg="black",
                       font=("times new roman", 17, "bold"))
        ...
        r_email = Label(rel, text="Email :", bg="lightblue", fg="black",
                     font=("times new roman", 17, "bold"))
        ...
        r_address = Label(rel, text="Address :", bg="lightblue", fg="black", font=("times new roman", 17, "bold"))
        ...
        r_type = Label(rel, text="Relative type :", bg="lightblue", fg="black",
                       font=("times new roman", 17, "bold"))
        ...
        addbtn = Button(self.rele, text="ADD", width=10, pady=5,bd=1, fg="maroon", bg="white", command=self.relative_details).place(x=70, y=470, width=80)

        updatebtn = Button(self.rele, text="UPDATE", width=10, pady=5, bd=1, fg="maroon", bg="white", command=self.update_data_relative).place(x=170, y=470,
                                                                                                       width=80)

        deletebtn = Button(self.rele, text="DELETE", width=10, pady=5,bd=1, fg="maroon", bg="white", command=self.delete_data_relative).place(x=270, y=470,
                                                                                                       width=80)
        clearbtn = Button(self.rele, text="CLEAR", width=10, pady=5,bd=1, fg="maroon", bg="white", command=self.clear_relative).place(x=370, y=470, width=80)
        ...
        pay = Frame(self.rele, bg="lightblue", bd=10)
        ...
        patient_id = Label(pay, text="Patient ID :", bg="lightblue", fg="black",
                           font=("times new roman", 17, "bold"))
        patient_id.grid(row=2, column=0, pady=10, padx=20, sticky="w")
        ...
        bill_num = Label(pay, text="Bill Number :", bg="lightblue", fg="black",
                           font=("times new roman", 17, "bold"))
        ...
        amount = Label(pay, text="Amount :", bg="lightblue", fg="black",
                           font=("times new roman", 17, "bold"))
        ...
        addbtn = Button(pay, text="ADD", width=10, pady=5, bd=1, fg="maroon", bg="white", command=self.payment_details).place(x=70, y=210,
                                                                                                            width=80)

        updatebtn = Button(pay, text="UPDATE", width=10, pady=5, bd=1, fg="maroon", bg="white", command=self.update_data_payment).place(x=170,
                                                                                                                y=210,
                                                                                                                width=80)

        deletebtn = Button(pay, text="DELETE", width=10, pady=5, bd=1, fg="maroon", bg="white", command=self.delete_data_payment).place(
            x=270, y=210,
            width=80)
        clearbtn = Button(pay, text="CLEAR", width=10, pady=5, bd=1, fg="maroon", bg="white", command=self.clear_payment).place(x=370,
                                                                                                              y=210,
                                                                                                              width=80)
    ...
    def payment_details(self):
        if self.Patient_id.get() == "" or self.Bill_number.get() == "":
            messagebox.showerror("Error", "all fields are required to fill ")
        else:
            con = pymysql.connect(host="localhost", user="root", database="c_patient")
            cur = con.cursor()
    ...
    def relative_details(self):
        if self.phone_no.get()=="" or self.name=="":
            messagebox.showerror("Error","all fields are required to fill ")
        else:
            con = pymysql.connect(host="localhost",user="root",database="c_patient")
            cur = con.cursor()
    ...
    def update_data_relative(self):
        con = pymysql.connect(host="localhost", user="root", database="c_patient")
        cur = con.cursor()
        cur.execute("UPDATE RELATIVES SET name=%s, type=%s, phone=%s, email=%s, address=%s WHERE patient_id=%s", (
